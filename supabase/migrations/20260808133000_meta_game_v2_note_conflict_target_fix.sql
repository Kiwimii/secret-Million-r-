-- PostgreSQL also treats the function parameter subject_member_id as ambiguous
-- inside an ON CONFLICT column list. Use the named primary-key constraint instead.
...
begin
  ...
  on conflict on constraint meta_notes_pkey
