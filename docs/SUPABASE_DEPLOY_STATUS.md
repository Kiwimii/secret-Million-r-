...
- Status: erfolgreich
- Zeitpunkt (UTC): 2026-07-24T04:15:58Z
...
2026/07/24 04:15:42 PG Send: {"Type":"StartupMessage","ProtocolVersion":196608,"Parameters":{"database":"postgres","user":"postgres.wxagegieaaqxuzwobgtc"}}
2026/07/24 04:15:42 PG Recv: {"Type":"AuthenticationSASL","AuthMechanisms":["SCRAM-SHA-256"]}
2026/07/24 04:15:42 PG Send: {"Type":"SASLInitialResponse","AuthMechanism":"SCRAM-SHA-256","Data":"n,,n=,r=4lQ54FMjwLLKHvxMI9Sv8l5o"}
2026/07/24 04:15:42 PG Recv: {"Type":"AuthenticationSASLContinue","Data":"r=4lQ54FMjwLLKHvxMI9Sv8l5oRUpMb21CZVQxWGxaOUk0ak5YeFlSTU16S1NEQw==,s=eO/JRUOoMGR440gkKqVPQg==,i=4096"}
2026/07/24 04:15:42 PG Send: {"Type":"SASLResponse","Data":"c=biws,r=4lQ54FMjwLLKHvxMI9Sv8l5oRUpMb21CZVQxWGxaOUk0ak5YeFlSTU16S1NEQw==,p=HfQwtVlWWJ773tJz82VcFxAJGdQr9pVA4qf6L4n+SjE="}
2026/07/24 04:15:42 PG Recv: {"Type":"AuthenticationSASLFinal","Data":"v=j6zPXVidAspO77qIQx6nF/M+cvazl/DWjiwpm3MhyaQ="}
2026/07/24 04:15:42 PG Recv: {"Type":"AuthenticationOK"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"DateStyle","Value":"ISO, MDY"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"IntervalStyle","Value":"postgres"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"TimeZone","Value":"UTC"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"application_name","Value":"Supavisor"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"client_encoding","Value":"UTF8"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"default_transaction_read_only","Value":"off"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"in_hot_standby","Value":"off"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"integer_datetimes","Value":"on"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"is_superuser","Value":"off"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"scram_iterations","Value":"4096"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"server_encoding","Value":"UTF8"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"server_version","Value":"17.6"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"session_authorization","Value":"postgres"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterStatus","Name":"standard_conforming_strings","Value":"on"}
2026/07/24 04:15:42 PG Recv: {"Type":"BackendKeyData","ProcessID":65795689,"SecretKey":603468217}
2026/07/24 04:15:42 PG Recv: {"Type":"ReadyForQuery","TxStatus":"I"}
2026/07/24 04:15:42 PG Send: {"Type":"Parse","Name":"lrupsc_1_0","Query":"SELECT version FROM supabase_migrations.schema_migrations ORDER BY version","ParameterOIDs":null}
2026/07/24 04:15:42 PG Send: {"Type":"Describe","ObjectType":"S","Name":"lrupsc_1_0"}
2026/07/24 04:15:42 PG Send: {"Type":"Sync"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParseComplete"}
2026/07/24 04:15:42 PG Recv: {"Type":"ParameterDescription","ParameterOIDs":[]}
2026/07/24 04:15:42 PG Recv: {"Type":"RowDescription","Fields":[{"Name":"version","TableOID":17482,"TableAttributeNumber":1,"DataTypeOID":25,"DataTypeSize":-1,"TypeModifier":-1,"Format":0}]}
2026/07/24 04:15:42 PG Recv: {"Type":"ReadyForQuery","TxStatus":"I"}
2026/07/24 04:15:42 PG Send: {"Type":"Bind","DestinationPortal":"","PreparedStatement":"lrupsc_1_0","ParameterFormatCodes":null,"Parameters":[],"ResultFormatCodes":[0]}
2026/07/24 04:15:42 PG Send: {"Type":"Describe","ObjectType":"P","Name":""}
2026/07/24 04:15:42 PG Send: {"Type":"Execute","Portal":"","MaxRows":0}
2026/07/24 04:15:42 PG Send: {"Type":"Sync"}
2026/07/24 04:15:42 PG Recv: {"Type":"BindComplete"}
2026/07/24 04:15:42 PG Recv: {"Type":"RowDescription","Fields":[{"Name":"version","TableOID":17482,"TableAttributeNumber":1,"DataTypeOID":25,"DataTypeSize":-1,"TypeModifier":-1,"Format":0}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260723143000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260723190000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260723193000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260723194500"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260723210000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260724000000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260724001000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260724002100"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260724010000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260724020000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"DataRow","Values":[{"text":"20260724021000"}]}
2026/07/24 04:15:42 PG Recv: {"Type":"CommandComplete","CommandTag":"SELECT 11"}
2026/07/24 04:15:42 PG Recv: {"Type":"ReadyForQuery","TxStatus":"I"}
Would push these migrations:
 • 20260724022000_add_safe_live_game_cleanup.sql
Finished supabase db push.
2026/07/24 04:15:42 PG Send: {"Type":"Terminate"}
2026/07/24 04:15:42 HTTP POST: https://eu.i.posthog.com/batch/
2026/07/24 04:15:43 HTTP GET: https://api.github.com/repos/supabase/cli/releases/latest
--- supabase-apply.log ---
...
Finished supabase db push.
2026/07/24 04:15:57 PG Send: {"Type":"Terminate"}
2026/07/24 04:15:57 HTTP POST: https://eu.i.posthog.com/batch/
```
